        ...
        <Wrapper className="mb-16 md:mb-14 lg:mb-0 2xl:mb-16 h-auto">
          ...
          <div className=" 2xl:mt-14 max-w-[48rem] md:max-2xl:mb-10 md:-mt-4 lg:max-2xl:-mt-0 space-y-3 mt-12 px-4 xl:ml-28 ">
            <motion.p
              ...
              className="text-black 2xl:text-[2.6rem] md:leading-[2.5rem] 2xl:leading-[2.0rem] font-bold xl:max-2xl:text-[2.5rem] font-Carnas text-[1.29rem] sm:text-[1.99rem] md:text-[2rem] carnas "
            >
