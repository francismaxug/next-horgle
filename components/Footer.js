...
function Footer() {
  return (
    <footer className="mt-12 lg:mt-28 px-3 xl:px-0 ">
      <Wrapper className=" h-auto">
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className=" md:grid md:grid-cols-2 sm:grid sm:grid-cols-2 sm:gap-x-5  lg:grid lg:grid-cols-3 sm:gap-y-8 sm:space-y-0 space-y-9 md:space-y-0 gap-8 m-auto mt-8"
        >
          <motion.div
            variants={childv}
          ...
          >
            ...
            <div className=" flex px-1 xl:px-0 text-skin-gray gap-x-3 text-xs leading-[1.3rem]">
              <svg
          ...
          >
            ...
            <div className=" flex text-skin-gray gap-x-2 text-xs leading-[1.3rem]">
              <div className=" flex flex-col space-y-2">
                <div className=" flex gap-4 px-1 xl:px-0 xl:ml-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <div className=" flex -ml-2.5 xl:ml-0">
        ...
        <hr className="mx-auto w-auto mt-10" />
        <div className="  text-skin-gray  text-center py-4 text-xs font-poppins">
          <p>
            {" "}
