...
const ImageSlider = () => {
  ...
  return (
    <div className=" border border-blue-400 flex h-auto sm:h-auto items-center justify-center md:h-[300px] flex-col lg:h-[500px] w-auto lg:w-full m-auto px-4 relative group">
      <div
        className=" h-40 overflow-hidden sm:h-48 sm:w-72 md:w-72 rounded-2xl border-2 w-auto bg-center mt-14 bg-cover duration-500"
